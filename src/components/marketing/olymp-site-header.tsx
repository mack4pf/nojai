...
export function OlympSiteHeader() {
        ...
        <div className="glass-panel relative overflow-hidden rounded-[30px] px-4 py-3 sm:px-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              <Button asChild variant="ghost" size="sm" className="hidden text-xs text-muted-foreground xl:inline-flex">
                <a href="https://nojai.io" target="_blank" rel="noreferrer">
                  All of NOJAI
              ...
              {session ? (
                <>
                  <Button asChild className="hidden bg-emerald-600 text-white hover:bg-emerald-500 sm:inline-flex">
